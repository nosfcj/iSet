...
export class FixAcaoUsuarioNotNull1741309905296 implements MigrationInterface {
    name = 'FixAcaoUsuarioNotNull1741309905296'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`Acao\` CHANGE \`Usuario_ID\` \`Usuario_ID\` int NULL COMMENT 'Identificador único do usuário' DEFAULT 'NULL'`);
